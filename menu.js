...
popularity: 8,
rating: 7,
tags: ['gluten free', 'original crust', 'thin crust']
};
...
const foodArr = [
    ...
    popularity: 6,
    rating: 4,
    tags: ['thick crust', 'cheese stuffed crust', 'calzone']
    }
]
...
const filterByProperty = (property, number, type) => {
    let filteredArr;
    if (type === 'above'){
        filteredArr = foodArr.filter(element => element[property] > number)
    } else if (type === 'below'){
        filteredArr = foodArr.filter(element => element[property] < number)
    }
    return filteredArr
