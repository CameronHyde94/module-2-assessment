...
//////////////////PROBLEM 3////////////////////
/* 
const canWeDeliver = zipCode    Below is an array of objects that have some
...
//CODE HERE
const priceCut = deals[0].title.replace('15', '10');
...
//CODE HERE
const familyDeal = deals[1].desc.replace('March', 'April').trim();
